...
- [[../wiki/LLM Agent Research Map.md]] — 将本库 21 个 sources 组织为 GUI agent、agent memory、个性化、反思、function calling、多智能体和知识库维护 6 条主线。type: synthesis; tags: LLM Agent, Research Map; sources: 21; updated: 2026-04-22

## Concepts

- [[../wiki/GUI Agent.md]] — 以图形界面为行动空间的 LLM/VLM agent，核心挑战包括长程执行、状态感知、错误恢复、评测复现和用户授权。type: concept; tags: GUI Agent, Mobile Agent, OS Agent, Web Navigation; sources: 10; updated: 2026-04-22
...
- [[../wiki/Mobile Agent Personalization.md]] — Mobile agent 根据用户历史、演示、行为日志和实时互动推断偏好，并校准主动帮助边界。type: concept; tags: Mobile Agent, Personalization, Consent; sources: 4; updated: 2026-04-22
- [[../wiki/Agent Reflection.md]] — Agent 在无外部或弱外部反馈下检查、修正和恢复自身推理或执行轨迹的机制。type: concept; tags: Reflection, Self-Correction, Error Recovery; sources: 4; updated: 2026-04-22
- [[../wiki/Function Calling.md]] — LLM agent 将用户意图映射为外部函数、API 或工具调用的能力，移动助手场景尤其关注多轮鲁棒性和参数错误。type: concept; tags: Function Calling, Tool Use, Mobile Assistant; sources: 3; updated: 2026-04-22
...
- [[../wiki/Long-Horizon Agent Evaluation.md]] — 面向长步骤、多状态、多路径和跨会话任务的 agent 评测问题。type: concept; tags: Benchmark, Long-Horizon, GUI Agent; sources: 10; updated: 2026-04-22
